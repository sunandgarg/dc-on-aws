...
BEGIN
  ...
  RAISE NOTICE 'AUTO_MODEL_SMOKE status=% progress=% step=% created=% message=%', latest.status, latest.progress, latest.current_step, latest.created_count, latest.message;
END
$audit$;
