...
const defaults: State = { text_model: "claude-3-5-sonnet-20241022", image_model: "gpt-image-2", image_quality: "medium", claude_key_set: false, openai_key_set: false };
